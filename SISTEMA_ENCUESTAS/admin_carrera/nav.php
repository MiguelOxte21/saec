<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link" href="../../SAC/administrador/index.php">
            ...
            <div class="collapse" id="collapseDashboards" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    <a class="nav-link" href="../../SAC/administrador/congreso/taller.php">Talleres</a>
            ...
            <div class="collapse" id="collapseLayouts" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                    <a class="nav-link" href="../../SAC/administrador/personal/instructores.php">Instructores</a>
                    <a class="nav-link" href="../../SAC/administrador/personal/alumnos.php">Alumnos</a>
                    <a class="nav-link" href="../../SAC/administrador/personal/activados.php">Activación</a>
            ...
            <div class="collapse" id="collapseLayoutsOtros" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                    <a class="nav-link" href="../../SAC/administrador/otros/index.php">Logo</a>
                    <a class="nav-link" href="../../SAC/administrador/otros/avisos.php">Avisos</a>
                </nav>
            </div>

            <div class="sidenav-menu-heading">Perfil</div>
            <a class="nav-link" href="../../SAC/administrador/perfil.php">
